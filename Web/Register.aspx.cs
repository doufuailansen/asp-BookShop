...
namespace Web
{
    public partial class WebRegister : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            account.ShopName = TextShopName.Text.Trim();
            account.ShopDescription = TextShopDescription.Text.Trim();
            // 注册成功
        ...
        protected void BeSeller_CheckedChanged(object sender, EventArgs e)
        {
            if (BeSeller.Checked)
            {
                TextShopName.Attributes.Remove("disabled");
                TextShopDescription.Attributes.Remove("disabled");
            }
        }
    }
}