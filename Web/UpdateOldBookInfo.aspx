<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Master/MasterPage2.master" AutoEventWireup="true" CodeFile="UpdateOldBookInfo.aspx.cs" Inherits="Web_UpdateOldBookInfo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="Page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">更新二手图书详细信息</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label>书名</label>
                            <asp:TextBox class="form-control" placeholder="书名" ID="TextName" runat="server"  Text =" "></asp:TextBox>
                            <p class="help-block">图书名称.</p>
                        </div>
                        <div class="form-group">
                            <label>作者</label>
                            <asp:TextBox class="form-control" placeholder="作者" ID="TextAuthor" runat="server" Text =" "></asp:TextBox>
                            <p class="help-block">图书作者.</p>
                        </div>
                        <div class="form-group">
                            <label>图片</label>
                            <asp:TextBox class="form-control" placeholder="图片" ID="TextImage" runat="server" Text = ""></asp:TextBox>
                            <p class="help-block">图片的地址.</p>
                        </div>
                        <div class="form-group">
                            <label>价格</label>
                            <asp:TextBox class="form-control" placeholder="价格" ID="TextPrice" runat="server" Text ="" ></asp:TextBox>
                            <p class="help-block">图书价格.</p>
                        </div>
                        
                        <div class="form-group">
                            <label>描述</label>
                            <asp:TextBox TextMode="multiline" placeholder="图书简介" class="form-control" Rows="3" ID="TextDescription" runat="server" Text =""></asp:TextBox>
