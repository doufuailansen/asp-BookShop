<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Master/PayMasterPage3.master" AutoEventWireup="true" CodeFile="Cart.aspx.cs" Inherits="Web.Cart" %>
    ...
    <script>
        ...
        $(function () {
            $(".buy_book").click(function () {
                $("#buy_book_name").text($(this).attr("bookName"));
                $("#ContentPlaceHolder1_BookId").val($(this).attr("bookId"));
    ...
    <div class="modal fade" id="confirm-buy" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span class="text-primary" id="buy_book_name"></span>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                    <asp:TextBox style="display: none;" ID="TextBox1" runat="server"></asp:TextBox>
                    <asp:Button class="btn btn-danger btn-ok" ID="Button1" runat="server" Text="下单" OnClick="BtnBuyBook_Click" />
                </div>
            </div>
        </div>
    </div>
