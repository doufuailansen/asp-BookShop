<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Master/MasterPage.master" AutoEventWireup="true" CodeFile="MyInfo.aspx.cs" Inherits="Web_MyInfo" %>
    ...
    <div id="" class ="card">
        ...
        <div class="row">
            <div class="text-center">
                <h1>个人信息<small> --XYZ <asp:Label style="color: #FF0000" ID="ErrorInfo" runat="server" Text=""></asp:Label></small></h1>
            </div>
        </div>
            <br />
            <div class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <asp:TextBox type="text" class="form-control" ID="TextAddress" runat="server" placeholder="请输入地址"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：</label>
                    <div class="col-sm-9">
                        <asp:TextBox type="text" class="form-control" ID="TextTelephone" runat="server" placeholder="请输入电话"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
