<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Master/MasterPage.master" AutoEventWireup="true" CodeFile="MyBuying.aspx.cs" Inherits="Web_MyOrder1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2>
        <strong style =" margin: 2%"><asp:Label class="text-primary" ID ="AccountName" runat ="server" Text=""></asp:Label></strong>的订单
    </h2>
